...
> **[v0.4.0-dev.29](https://github.com/alejandrobellver/pichiwa-patches/releases/tag/v0.4.0-dev.29)**&nbsp;&nbsp;•&nbsp;&nbsp;`dev`&nbsp;&nbsp;•&nbsp;&nbsp;18 patches total
<details open>
...
| [Login Fix](#login-fix) | Bypasses verification bans by redirecting all GMS communication to microG-RE. REQUIRED: You must manually install microG-RE for Play Integrity to pass. |  |
